...
//Setup Heading dataShows for Users Number of Results to Show
        ...
        var chooser=[5,15,25,50,100,150,250,500],options="";
		for(var q=0;q<chooser.length;q++){
			if(obj.shows==chooser[q]){
				options+="<option selected>"+chooser[q]+"</option>";
			}else {
                options += "<option>" + chooser[q] + "</option>";
            }
		}
