...
(1, 1, 'Commissioner', 0, 'RWF', 0, '', CURRENT_TIMESTAMP),
(2, 1, 'Agaciro Development Fund', 0, 'RWF', 0, '', CURRENT_TIMESTAMP),
(3, 2, 'Postoffice', 0, '%', 0, '', CURRENT_TIMESTAMP),
(4, 2, 'Agaciro Development Fund', 0, '%', 0, '', CURRENT_TIMESTAMP),
(5, 3, 'Postoffice', 0, '%', 0, '', CURRENT_TIMESTAMP),
(6, 3, 'Agaciro Development Fund', 0, '%', 0, '',CURRENT_TIMESTAMP);
...
(1, 'Registration', '', 0, 0, NULL, CURRENT_TIMESTAMP),
(2, 'Losts', 'Registered', 0, 0, NULL, CURRENT_TIMESTAMP),
(3, 'Losts', 'Non Registered', 0, 0, NULL,CURRENT_TIMESTAMP);
...
--
ALTER TABLE `payment_mode`
  MODIFY `pmtd_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `postoffices`
--
ALTER TABLE `postoffices`
  MODIFY `postoff_id` int(50) NOT NULL AUTO_INCREMENT;
--
