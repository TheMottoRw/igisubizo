...
(1, 1, 'Commissioner', 40, 'RWF', 0, '', '2018-07-11 14:59:03'),
(2, 1, 'Agaciro Development Fund', 40, 'RWF', 0, '', '2018-07-11 14:59:03'),
(3, 2, 'Postoffice', 15, '%', 0, '', '2018-07-11 14:59:03'),
(4, 2, 'Agaciro Development Fund', 15, '%', 0, '', '2018-07-11 14:59:03'),
(5, 3, 'Postoffice', 15, '%', 0, '', '2018-07-11 14:59:03'),
(6, 3, 'Agaciro Development Fund', 15, '%', 0, '', '2018-07-11 14:59:03');
...
(8, 'National ID', 0, 0, '', '2018-07-11'),
(9, 'Passport', 0, 0, '', '2018-07-11'),
(10, 'Driving licence ', 0, 0, '', '2018-07-11'),
(11, 'Laissez-passer ', 0, 0, '', '2018-07-11'),
(12, 'Diploma', 0, 0, '', '2018-07-11'),
(13, 'Insurance card', 0, 0, '', '2018-07-11'),
(14, 'Land property ', 0, 0, '', '2018-07-11'),
(15, 'TV', 0, 1, 'Not needed ', '2018-07-11'),
(16, 'TV Screen ', 0, 0, '', '2018-07-11'),
(17, 'Telephone', 0, 0, '', '2018-07-11'),
(18, 'Computer ', 0, 0, '', '2018-07-11'),
(19, 'Student Card', 1, 0, '', '2018-07-12');
--
...
(1, 'Registration', '', 300, 0, NULL, '2018-07-11 14:59:03'),
(2, 'Losts', 'Registered', 500, 0, NULL, '2018-07-11 14:59:03'),
(3, 'Losts', 'Non Registered', 2000, 0, NULL, '2018-07-11 14:59:03');
...
(1, 0, 'Citizen', 0, 'KABANO Bea', '0789674523', 300, 'approved', 1, '2018-07-11 19:41:31', 0, '', '2018-07-11 19:32:00');
...
(1, 'MTN Mobile Money ', 'MTN', 'MUGISHA Germain', '0782499060', 0, '', 0, '2018-07-11 18:39:00', '2018-07-11 18:39:00');
...
(1, 'KACYIRU', 1, '0783403456', '240b2b448c3b62f9d74fb3da0ce46c84', 5, 28, '196', 'Knserege', 'KIGALI-RWANDA', 1, 'not needed', '2018-07-11');
...
(1, 0, 0, '', 8, '1199080186789089', 'sms', '', 'pending', 0, '', '2018-07-11');
...
(1, 'KABANDA Chritian', '0789909089', 'christian@gmail.com', 0, '', '2018-07-11');
...
(1, 'Admin Admin', 0, 'admin', 0726183049, 'adminstrator@bfg.rw', '2f7535bc6eac9e1a4227b395a3f9a3da', 1, 'BFG Headquarter', 0, 0, 0, 0, '', '2018-07-11'),
(2, 'Kubwimana Theophile', 2147483647, 'Theos', 0780466156, 'kubwimanatheophile250@gmail.com', '923d4b07b9f87f17936ea676335e2f33', 2, 'Karongi Kibuye', 0, 0, 0, 0, '', '2018-07-11');
...
(1, 'Adminstrator', 0, NULL, CURRENT_TIMESTAMP),
(2, 'Commissioner', 0, NULL, CURRENT_TIMESTAMP),
(3, 'Government', 0, NULL, CURRENT_TIMESTAMP);
...
--
ALTER TABLE `doctypes`
  MODIFY `doc_id` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `payment_history`
  MODIFY `pmth_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `payment_mode`
--
ALTER TABLE `payment_mode`
  MODIFY `pmtd_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `queue`
  MODIFY `queue_id` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `usertypes`
  MODIFY `usrt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
