...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2018 at 04:17 PM
...
INSERT INTO `citizens` (`cit_id`, `cit_commissionerid`, `cit_names`, `cit_phone`, `cit_email`, `cit_nid`, `reg_amount`, `cit_commission`, `cit_agaciro`, `cit_remain`, `regdate`) VALUES
(4, 0, 'Murenzi Ernest', '07895463234', '', '119900', 0, 0, 0, 0, '2018-07-08 18:17:45'),
(5, 0, 'Kamana Fracnois', '0789546342', '', '119901', 300, 0, 40, 260, '2018-07-08 18:18:04'),
(6, 2, 'Manzi Roger', '0784634118', '', '1199880045073123', 0, 0, 0, 0, '2018-07-08 18:20:04'),
(7, 2, 'Kanyana Rug Aline', '0780398390', '', '119902', 300, 40, 40, 0, '2018-07-09 03:31:06'),
(8, 2, 'NIYGABA Eric', '0723123543', '', '119968435467529', 300, 40, 40, 220, '2018-07-09 03:39:36'),
(9, 2, 'Hakizimana Dieudonne', '0780546433', '', '321', 300, 40, 40, 220, '2018-07-10 11:00:51'),
(10, 2, 'Kaneza Liliane', '07895445323', '', '98765', 300, 40, 40, 220, '2018-07-10 20:35:04');
...
(1, 1, 'Commissioner', 40, 'RWF', 0, '', '2018-07-05 12:04:16'),
(2, 1, 'Agaciro Development Fund', 40, 'RWF', 0, '', '2018-07-05 12:04:16'),
(3, 2, 'Postoffice', 15, '%', 0, '', '2018-07-05 12:04:16'),
(4, 2, 'Agaciro Development Fund', 15, '%', 0, '', '2018-07-05 12:04:16'),
(5, 3, 'Postoffice', 15, '%', 0, '', '2018-07-05 12:04:16'),
(6, 3, 'Agaciro Development Fund', 15, '%', 0, '', '2018-07-05 12:04:17');
...
INSERT INTO `doctypes` (`doc_id`, `doctype`, `max_items`, `delete_status`, `delete_reason`, `regdate`) VALUES
(1, 'Identity Card', 1, 0, '', '2018-06-26'),
(2, 'Driving License', 0, 0, '', '2018-06-26'),
(3, 'School Report', 0, 0, '', '2018-06-26');
...
(1, 1, 1, 1, 'MANZI Hasua', '119988045073123', '', '', 0, 0, 0, 0, 'pending', 0, '', '2018-07-07'),
(2, 1, 1, 2, 'Ingabire Denise', 'KN1231', '', '', 2000, 200, 300, 1500, 'pending', 0, '', '2018-07-08');
...
(3, 'Losts', 'Non Registered', 2000, 0, NULL, '2018-07-04 14:09:28');
...
CREATE TABLE `payment_history` (
  ...
  `pmth_payer_id` int(11) DEFAULT NULL,
  `pmth_payer_type` varchar(15) DEFAULT NULL,
  `payment_mode` int(11) NOT NULL,
  `pmth_sender_name` varchar(60) NOT NULL,
  `pmth_sender_phone` varchar(15) NOT NULL,
...
INSERT INTO `payment_history` (`pmth_id`, `pmth_payer_id`, `pmth_payer_type`, `payment_mode`, `pmth_sender_name`, `pmth_sender_phone`, `pmth_amount`, `pmth_status`, `pmth_approvedby`, `pmth_approval_date`, `delete_status`, `delete_reason`, `regdate`) VALUES
(1, 4, 'Citizen', 2, '', '', 300, 'pending', 0, '0000-00-00 00:00:00', 0, '', '2018-07-10 10:54:00'),
(2, NULL, 'Citizen', 2, 'Eric', '0722343534', 300, 'pending', 0, '0000-00-00 00:00:00', 0, '', '2018-07-10 13:46:00'),
(3, 5, 'Citizen', 2, 'Muneza JMV', '0722343532', 300, 'approved', 1, '2018-07-11 13:36:15', 0, '', '2018-07-10 13:47:00'),
(4, 2, 'Commissioner', 2, 'James Fred', '078756555465', 4500, 'approved', 1, '2018-07-11 13:37:03', 0, '', '2018-07-10 23:10:00');
...
(2, 'Tigo Cash', 'Tigo Part of Airtel', 'MANZI NERETSE Roger', '0726183049', 0, '', 0, '2018-07-05 07:46:00', '2018-07-05 07:46:00');
...
CREATE TABLE `queue` (
  ...
  `queue_citizenid` int(11) NOT NULL,
  `queue_commissionerid` int(11) DEFAULT NULL,
  `name` varchar(50) NOT NULL,
...
INSERT INTO `queue` (`queue_id`, `queue_citizenid`, `queue_commissionerid`, `name`, `queue_type`, `queue_identifier`, `notification_receive`, `address`, `queue_status`, `delete_status`, `delete_reason`, `regdate`) VALUES
(1, 0, NULL, 'Manzi Hasua', 1, 'KM100', '', 'Nkoto', 'pending', 0, '', '2018-06-30'),
(2, 6, 0, '', 3, 'KX120', 'sms', '', 'pending', 0, '', '2018-07-08'),
(3, 6, 2, '', 2, 'KN4505', 'sms', '', 'pending', 0, '', '2018-07-08'),
(4, 6, 0, '', 2, 'LK32', 'sms', '', 'pending', 0, '', '2018-07-11'),
(5, 6, 0, '', 2, 'LK32', 'sms', '', 'pending', 0, '', '2018-07-11'),
(6, 0, 0, '', 2, 'LK32', 'sms', '', 'pending', 0, '', '2018-07-11'),
(7, 6, 0, '', 2, 'LK31', 'sms', '', 'pending', 0, '', '2018-07-11'),
(8, 6, 0, '', 2, 'LK33', 'sms', '', 'pending', 0, '', '2018-07-11'),
(9, 6, 0, '', 2, 'LK23', 'sms', '', 'pending', 0, '', '2018-07-11'),
(10, 6, 0, '', 1, 'LK13', 'sms', '', 'pending', 0, '', '2018-07-11'),
(11, 6, 0, '', 1, 'NM23', 'sms', '', 'pending', 0, '', '2018-07-11');
...
(1, 'Admin Admin', 0, 'admin', 784343545, 'admin@yahoo.com', '2f7535bc6eac9e1a4227b395a3f9a3da', 1, 'BFG Headquarter', 0, 0, 0, 0, '', '2017-10-16'),
(2, 'Kubwimana Theophile', 2147483647, 'Theos', 726324323, 'kubwimanatheophile250@gmail.com', '923d4b07b9f87f17936ea676335e2f33', 2, 'Karongi Kibuye', 0, 0, 0, 0, '', '2018-07-05');
...
CREATE TABLE `withdraw_history` (
  ...
  `wth_commissioner_id` int(11) NOT NULL,
  `withdraw_mode` int(11) NOT NULL,
  `wth_amount` int(11) NOT NULL,
  `wth_status` varchar(15) NOT NULL,
  `wth_approvedby` int(11) NOT NULL,
  `wth_approval_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `delete_status` tinyint(1) NOT NULL,
  `delete_reason` varchar(255) NOT NULL,
  `regdate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `queue`
  ...
  ADD KEY `queue_citizenid` (`queue_citizenid`);
...
--
ALTER TABLE `losts`
  MODIFY `lost_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `payment_history`
  MODIFY `pmth_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `queue`
  MODIFY `queue_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
